				...
				<div class="row team">
				    <div class="col-lg-4 col-md-12">
				        <div class="team-photo mobile-mb-40">
				            <img src="<?php echo e(asset('assets/images/teachers/team-single.jpg')); ?> " alt="Team1">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6">
		                <div class="team-item">
		                    <div class="team-img">
		                        <a href="#"><img src="<?php echo e(asset('assets/images/teachers/5.jpg')); ?>" alt="" /></a>
					...
					<div class="col-lg-3 col-md-6">
		                <div class="team-item">
		                    <div class="team-img">
		                        <a href="#"><img src="<?php echo e(asset('assets/images/teachers/6.jpg')); ?>" alt="" /></a>
		                        <div class="social-icon">
		                        	<a href="#"><i class="fa fa-facebook"></i></a>
		                        	<a href="#"><i class="fa fa-twitter"></i></a>
		                        	<a href="#"><i class="fa fa-google-plus"></i></a>
					...
					<div class="col-lg-3 col-md-6">
		                <div class="team-item">
		                    <div class="team-img">
		                        <a href="#"><img src="<?php echo e(asset('assets/images/teachers/7.jpg')); ?>" alt="" /></a>
		                        <div class="social-icon">
		                        	<a href="#"><i class="fa fa-facebook"></i></a>
		                        	<a href="#"><i class="fa fa-twitter"></i></a>
		                        	<a href="#"><i class="fa fa-google-plus"></i></a>
					...
					<div class="col-lg-3 col-md-6">
		                <div class="team-item">
		                    <div class="team-img">
		                        <a href="#"><img src="<?php echo e(asset('assets/images/teachers/8.jpg')); ?>" alt="" /></a>
		                        <div class="social-icon">
		                        	<a href="#"><i class="fa fa-facebook"></i></a>
		                        	<a href="#"><i class="fa fa-twitter"></i></a>
		                        	<a href="#"><i class="fa fa-google-plus"></i></a>
...
<?php /* C:\xampp\htdocs\pelatihan\resources\views/frontend/pages/staff-detail.blade.php */ ?>