			...
			<div class="container">
				...
				<div class="row grid">
					...
					<div class="col-lg-4 col-md-6 grid-item filter4">
		                <div class="course-item">
		                    <div class="course-img">
		                        <img src="<?php echo e(asset('assets/images/courses/12.jpg')); ?> " alt="" />
		                        <span class="course-value">$450</span>
		                        <div class="course-toolbar">
					...
					<div class="col-lg-4 col-md-6 grid-item filter3">
		                <div class="course-item">
		                    <div class="course-img">
		                        <img src="<?php echo e(asset('assets/images/courses/14.jpg')); ?> " alt="" />
		                        <span class="course-value">$450</span>
		                        <div class="course-toolbar">
					...
					<div class="col-lg-4 col-md-6 grid-item filter2">
		                <div class="course-item">
		                    <div class="course-img">
		                        <img src="<?php echo e(asset('assets/images/courses/15.jpg')); ?>" alt="" />
		                        <span class="course-value">$450</span>
		                        <div class="course-toolbar">
					...
					<div class="col-lg-4 col-md-6 grid-item filter4">
		                <div class="course-item">
		                    <div class="course-img">
		                        <img src="<?php echo e(asset('assets/images/courses/16.jpg')); ?>" alt="" />
					...
					<div class="col-lg-4 col-md-6 grid-item filter3 filter4">
		                <div class="course-item">
		                    <div class="course-img">
		                        <img src="<?php echo e(asset('assets/images/courses/17.jpg')); ?>" alt="" />
		                        <span class="course-value">$450</span>
		                        <div class="course-toolbar">
		                    		<h4 class="course-category"><a href="courses-details.html">Humanities</a></h4>
		                        	<div class="course-date">
					...
					<div class="col-lg-4 col-md-6 grid-item filter1">
		                <div class="course-item">
		                    <div class="course-img">
		                        <img src="<?php echo e(asset('assets/images/courses/18.jpg')); ?>" alt="" />
...
<?php /* C:\xampp\htdocs\pelatihan\resources\views/frontend/pages/courses.blade.php */ ?>