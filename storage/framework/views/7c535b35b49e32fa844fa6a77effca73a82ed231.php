                    ...
                    <div class="col-lg-6 col-md-12">
                    	<div class="event-item">
	                        <div class="row rs-vertical-middle">
	                        	<div class="col-md-6">
	                        	    <div class="event-img">
	                        	        <img src="<?php echo e(asset('assets/images/events/4.jpg')); ?> " alt="events Images" />
	                        	...
	                        	<div class="col-md-6">
	                    	        <div class="event-content">
	                    	        	...
	                    	        	<div class="event-btn">
	                    	        		<a href="/event_detail">Join Event</a>
	                    	        	</div>
	                    	        </div>                    		
	                        	</div>
	                        </div>                    		
                    ...
                    <div class="col-lg-6 col-md-12">
                    	<div class="event-item">
	                        <div class="row rs-vertical-middle">
	                        	<div class="col-md-6">
	                        	    <div class="event-img">
	                        	        <img src="<?php echo e(asset('assets/images/events/5.jpg')); ?> " alt="events Images" />
                                        <a class="image-link" href="images/events/kids1.jpg" title="University Tour 2018">
                                            <i class="fa fa-link"></i>
                                        </a>
	                        	    </div>                        		
	                        	</div>
                    ...
                    <div class="col-lg-6 col-md-12">
                    	<div class="event-item">
	                        <div class="row rs-vertical-middle">
	                        	<div class="col-md-6">
	                        	    <div class="event-img">
	                        	        <img src="<?php echo e(asset('assets/images/events/6.jpg')); ?> " alt="events Images" />
                                        <a class="image-link" href="events-details.html" title="University Tour 2018">
                                            <i class="fa fa-link"></i>
                                        </a>
	                        	    </div>                        		
                    ...
                    <div class="col-lg-6 col-md-12">
                    	<div class="event-item">
	                        <div class="row rs-vertical-middle">
	                        	<div class="col-md-6">
	                        	    <div class="event-img">
	                        	        <img src="<?php echo e(asset('assets/images/events/7.jpg')); ?> " alt="events Images" />
                                        <a class="image-link" href="events-details.html" title="University Tour 2018">
                                            <i class="fa fa-link"></i>
                                        </a>
	                        	    </div>                        		
                    ...
                    <div class="col-lg-6 col-md-12">
                    	<div class="event-item">
	                        <div class="row rs-vertical-middle">
	                        	<div class="col-md-6">
	                        	    <div class="event-img">
	                        	        <img src="<?php echo e(asset('assets/images/events/8.jpg')); ?> " alt="events Images" />
                                        <a class="image-link" href="events-details.html" title="University Tour 2018">
                                            <i class="fa fa-link"></i>
                                        </a>
	                        	    </div>                        		
                    ...
                    <div class="col-lg-6 col-md-12">
                    	<div class="event-item">
	                        <div class="row rs-vertical-middle">
	                        	<div class="col-md-6">
	                        	    <div class="event-img">
	                        	        <img src="<?php echo e(asset('assets/images/events/9.jpg')); ?> " alt="events Images" />
                                        <a class="image-link" href="events-details.html" title="University Tour 2018">
                                            <i class="fa fa-link"></i>
                                        </a>
	                        	    </div>                        		
				...
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="branches-item">
							<img src="<?php echo e(asset('assets/images/about/australia.png')); ?>" alt="Australia Flag">
							<h3>
								<span>01</span>
								Australia
							</h3>
					...
					<div class="col-lg-3 col-md-6">
						<div class="branches-item">
							<img src="<?php echo e(asset('assets/images/about/china.png')); ?> " alt="China Flag">
							<h3>
								<span>02</span>
								China
							</h3>
					...
					<div class="col-lg-3 col-md-6">
						<div class="branches-item">
							<img src="<?php echo e(asset('assets/images/about/india.png')); ?>" alt="India Flag">
							<h3>
								<span>03</span>
								India
							</h3>
					...
					<div class="col-lg-3 col-md-6">
						<div class="branches-item">
							<img src="<?php echo e(asset('assets/images/about/united-states.png')); ?>" alt="United States Flag">
							<h3>
								<span>04</span>
								United States
							</h3>
...
<?php /* C:\xampp\htdocs\pelatihan\resources\views/frontend/pages/event.blade.php */ ?>