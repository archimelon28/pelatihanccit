				...
				<div class="row">
					<div class="col-lg-8 col-md-12">
						<div class="single-image">
							<img src="<?php echo e(asset('assets/images/blog-details/1.jpg')); ?> " alt="single">
							...
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-12">
									<div class="popular-post-img">
										<a href="#"><img src="<?php echo e(asset('assets/images/blog-details/mid1.jpg')); ?> " alt="Blog single photo"></a>                                   
									</div>                                
									<h5>
								...
								<div class="col-lg-4 col-md-4 col-sm-12">
									<div class="popular-post-img">
										<a href="#"><img src="<?php echo e(asset('assets/images/blog-details/mid2.jpg')); ?> " alt="Blog single photo"></a>                                   
									</div>                                
									<h5>
										<a href="#">Easy to Use Your Gallery</a>
									</h5>
								...
								<div class="col-lg-4 col-md-4 col-sm-12">
									<div class="popular-post-img">
										<a href="#"><img src="<?php echo e(asset('assets/images/blog-details/mid3.jpg')); ?> " alt="Blog single photo"></a>                                  
									</div>                                
									<h5>
										<a href="#">Easy to Use Your Gallery</a>
									</h5>
						...
						<div class="author-comment">
							...
							<ul>
								<li>
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
											<div class="image-comments"><img src="<?php echo e(asset('assets/images/blog-details/comment.png')); ?> " alt="Blog Details photo"></div>
										</div>
								...
								<li>
									<div class="row">
										<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
											<div class="image-comments"><img src="<?php echo e(asset('assets/images/blog-details/comment.png')); ?> " alt="Blog single photo"></div>
										</div>
										<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
											<span class="reply"><span class="date"><i class="fa fa-calendar" aria-hidden="true"></i> Sep 13, 2017</span></span>
											<div class="dsc-comments">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="sidebar-area">
                            ...
                            <div class="latest-courses">
                                ...
                                <div class="post-item">
	                                <div class="post-img">
	                                    <a href="blog-details.html"><img src="<?php echo e(asset('assets/images/blog-details/sm1.jpg')); ?> " alt="" title="News image"></a>
	                                </div>
	                                <div class="post-desc">
	                            ...
	                            <div class="post-item">
	                                <div class="post-img">
	                                    <a href="blog-details.html"><img src="<?php echo e(asset('assets/images/blog-details/sm2.jpg')); ?> " alt="" title="News image"></a>
	                                </div>
	                                <div class="post-desc">
	                                    <h4><a href="blog-details.html">Raken develops reporting The software</a></h4>
	                                    <span class="duration"> 
	                            ...
	                            <div class="post-item">
	                                <div class="post-img">
	                                    <a href="blog-details.html"><img src="<?php echo e(asset('assets/images/blog-details/sm3.jpg')); ?> " alt="" title="News image"></a>
	                                </div>
	                                <div class="post-desc">
	                                    <h4><a href="blog-details.html">Raken develops reporting The software</a></h4>
	                                    <span class="duration"> 
...
<?php /* C:\xampp\htdocs\pelatihan\resources\views/frontend/pages/news_detail.blade.php */ ?>