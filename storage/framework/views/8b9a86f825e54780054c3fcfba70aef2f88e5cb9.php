                ...
                <div class="row mb-30">
                    <div class="col-lg-8 col-md-12">
                	    <div class="detail-img">
                	        <img src="<?php echo e(asset('assets/images/courses/courses-details.jpg')); ?> " alt="Courses Images" />
                	    			...
                	    			<div class="col-md-6 mobile-mb-20">
                	    				...
                	    				<div class="instructor-inner">
                	    					<div class="instructor-img">
                	    						<img src="<?php echo e(asset('assets/images/teachers/2.jpg')); ?> " alt="Teachers Images" />
                	    					</div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="sidebar-area">
                            ...
                            <div class="latest-courses">
                                ...
                                <div class="post-item">
	                                <div class="post-img">
	                                    <a href="courses-details.html"><img src="<?php echo e(asset('assets/images/blog-details/sm1.jpg')); ?>" alt="" title="News image"></a>
	                                </div>
	                                <div class="post-desc">
	                            ...
	                            <div class="post-item">
	                                <div class="post-img">
	                                    <a href="courses-details.html"><img src="<?php echo e(asset('assets/images/blog-details/sm2.jpg')); ?>" alt="" title="News image"></a>
	                                </div>
	                                <div class="post-desc">
	                                    <h4><a href="courses-details.html">Raken develops reporting The software</a></h4>
	                                    <span class="duration"> 
	                            ...
	                            <div class="post-item">
	                                <div class="post-img">
	                                    <a href="courses-details.html"><img src="<?php echo e(asset('assets/images/blog-details/sm3.jpg')); ?> " alt="" title="News image"></a>
	                                </div>
	                                <div class="post-desc">
	                                    <h4><a href="courses-details.html">Raken develops reporting The software</a></h4>
	                                    <span class="duration"> 
                	...
                	<div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="1500" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-ipad-device="2" data-ipad-device-nav="true" data-md-device="3" data-md-device-nav="true">
                        <div class="course-item">
                            <div class="course-img">
                                <img src="<?php echo e(asset('assets/images/courses/10.jpg')); ?> " alt="" />
                        ...
                        <div class="course-item">
                            <div class="course-img">
                                <img src="<?php echo e(asset('assets/images/courses/11.jpg')); ?> " alt="" />
                                <span class="course-value">$450</span>
                                <div class="course-toolbar">
                        ...
                        <div class="course-item">
                            <div class="course-img">
                                <img src="<?php echo e(asset('assets/images/courses/13.jpg')); ?> " alt="" />
                                <span class="course-value">$450</span>
                                <div class="course-toolbar">
...
<?php /* C:\xampp\htdocs\pelatihan\resources\views/frontend/pages/courses-detail.blade.php */ ?>