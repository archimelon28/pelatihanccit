                ...
                <div class="row mb-30">
                    <div class="col-lg-8 col-md-12">
                	    <div class="detail-img">
                	        <img src="{{asset('assets/images/courses/courses-details.jpg')}} " alt="Courses Images" />
                	    			...
                	    			<div class="col-md-6 mobile-mb-20">
                	    				...
                	    				<div class="instructor-inner">
                	    					<div class="instructor-img">
                	    						<img src="{{asset('assets/images/teachers/2.jpg')}} " alt="Teachers Images" />
                	    					</div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="sidebar-area">
                            ...
                            <div class="latest-courses">
                                ...
                                <div class="post-item">
	                                <div class="post-img">
	                                    <a href="courses-details.html"><img src="{{asset('assets/images/blog-details/sm1.jpg')}}" alt="" title="News image"></a>
	                                </div>
	                                <div class="post-desc">
	                            ...
	                            <div class="post-item">
	                                <div class="post-img">
	                                    <a href="courses-details.html"><img src="{{asset('assets/images/blog-details/sm2.jpg')}}" alt="" title="News image"></a>
	                                </div>
	                                <div class="post-desc">
	                                    <h4><a href="courses-details.html">Raken develops reporting The software</a></h4>
	                                    <span class="duration"> 
	                            ...
	                            <div class="post-item">
	                                <div class="post-img">
	                                    <a href="courses-details.html"><img src="{{asset('assets/images/blog-details/sm3.jpg')}} " alt="" title="News image"></a>
	                                </div>
	                                <div class="post-desc">
	                                    <h4><a href="courses-details.html">Raken develops reporting The software</a></h4>
	                                    <span class="duration"> 
